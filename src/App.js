      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-8 shadow-lg relative overflow-hidden">
        <div className="container mx-auto px-4 relative">
          <div className="text-center">
            ...
            <p className="text-2xl mb-6 font-light tracking-wide animate-fade-in-up">📞 รายการสายด่วนประเทศไทย โดยนักศึกษาสาขาเทคโนโลยีสารสนเทศ ป.ตรี วท.แพร่ </p>
      ...
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12 mt-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-400">&copy; {new Date().getFullYear()} SOS GO. พัฒนานักศึกษาสาขาเทคโนโลยีสารสนเทศ ป.ตรี วท.แพร่</p>
          </div>
        </div>
      </footer>
    </div>
